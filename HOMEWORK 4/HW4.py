...
# -*- coding: utf-8 -*-
"""
Created on Wed May 10 16:09:38 2017
...
#    pl.plot(angles,output_dB,'-bs',markeredgecolor = 'k')
    ...
    pl.ylabel('dB')
    pl.savefig('Drawings/'+'MUSICNOISEEIGENVECTORS.eps')
    pl.show()
...
#    pl.plot(angles,output_dB,'-ro',markeredgecolor = 'k')
    ...
    pl.ylabel('dB')
    pl.savefig('Drawings/'+'MUSICSIGNALEIGENVECTORS.eps')
    pl.show() 
