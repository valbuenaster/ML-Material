...
# -*- coding: utf-8 -*-
"""
Created on Sat Apr  8 23:17:37 2017
...
#    pl.quiver(media_X[0],media_X[1],math.sqrt(S[0])*U[0,0],math.sqrt(S[0])*U[1,0],angles='xy', scale_units='xy', scale=1)
#    pl.quiver(media_X[0],media_X[1],math.sqrt(S[1])*U[0,1],math.sqrt(S[1])*U[1,1],angles='xy', scale_units='xy', scale=1)
#    pl.plot([float(media_X[0] + math.sqrt(S[0])*U[0,0])],[float(media_X[1] + math.sqrt(S[0])*U[1,0])],'ks')
#    pl.plot([float(media_X[0] - math.sqrt(S[0])*U[0,0])],[float(media_X[1] - math.sqrt(S[0])*U[1,0])],'ks')
